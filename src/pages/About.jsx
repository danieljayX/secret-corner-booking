      ...
      <div className={`relative px-6 pt-12 pb-10 flex flex-col items-center text-center overflow-hidden`}>
        ...
        <div className={`relative w-20 h-20 rounded-full flex items-center justify-center mb-5 border shadow-xl ${isDarkMode ? 'bg-black border-white/10 shadow-pink-500/20' : 'bg-white border-pink-100 shadow-pink-200/50'}`}>
          {contactInfo.logo_url ? (
            <img src={contactInfo.logo_url} alt="Logo" className="w-full h-full object-cover rounded-full" />
          ) : (
          ...
          <div className="space-y-4">
            ...
            <a href={`tel:${contactInfo.phone}`} className="flex items-center gap-4 group">
              ...
              <div>
                ...
                <p className={`text-sm font-black ${textColor} group-hover:text-pink-500 transition-colors`}>{contactInfo.phone}</p>
              </div>
            </a>

            <a href={contactInfo.facebook_url} target="_blank" rel="noreferrer" className="flex items-center gap-4 group">
              ...
              <div>
                ...
                <p className={`text-sm font-black ${textColor} group-hover:text-pink-500 transition-colors`}>{contactInfo.facebook_page}</p>
              </div>
            </a>

            <a href={contactInfo.instagram_url} target="_blank" rel="noreferrer" className="flex items-center gap-4 group">
              ...
              <div>
                ...
                <p className={`text-sm font-black ${textColor} group-hover:text-pink-500 transition-colors`}>{contactInfo.instagram_handle}</p>
              </div>
            </a>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className={`text-sm font-black ${textColor}`}>{contactInfo.location}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className={`text-sm font-black ${textColor}`}>{contactInfo.email}</p>
              </div>
            </div>
          </div>
        </div>
